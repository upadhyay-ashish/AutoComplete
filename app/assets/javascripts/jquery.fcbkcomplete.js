    ...
    $.fn.fcbkcomplete = function(opt){
        return this.each(function(){
            ...
            function createFCBK(){
                ...
                //complete.append('<div class="default">' + options.complete_text + "</div>"); --commented
            ...
            function addInput(focusme){
                ...
                holder.click(function(){
                    ...
                    if (feed.length && input.val().length) {
                        ...
                        feed.hide();
//                        browser_msie ? browser_msie_frame.hide() : '';
                        //complete.children(".default").show();  --commented
                    }
                });
...
//                        browser_msie ? browser_msie_frame.hide() : '';
                    ...
                    if (event.keyCode != 40 && event.keyCode != 38 && etext.length != 0) {
                        ...
                        if (options.json_url) {
                            if (options.cache && json_cache) {
                                ...
                                setTimeout (function() {
                                    ...
                                    var url = options.json_url + ( options.json_url.indexOf("?") > -1 ? "&" : "?" ) +"tag="+encodeURI(etext);
                        ...
                        //complete.children(".default").hide();  --commented
                        feed.show();
                    }
                });
                if (focusme) {
            ...
            function addMembers(etext, data){
                ...
                if (data != null && data.length) {
                    $.each(data, function(i, val){
                     ...
                     search_string += "" + (cache.length - 1) + ":" + val.caption.replace(/[\(|\)]/g, "") + ";";
                    });
                }
                ...
                var myregexp, match;
                try {
                    myregexp = eval('/(?:^|;)\\s*(\\d+)\\s*:[^;]*?' + etext.replace(/[\(|\)]/g, "") + '[^;]*/g' + filter);
